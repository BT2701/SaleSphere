...
class KhuyenMaiModel
{
    ...
    public function TaoMoiKhuyenMaiModel($coupondInfo)
    {
    ...
    {
        $conn = $this->getInstance();
        if ($this->XoaChiTietKhuyenMaiModel($coupondID, $conn)) {
...
// }
    ...
    function SaveDetailApplyCoupondModel($couponID, $listProductIDWannaApply)
    {
        ...
        if ($listProductIDWannaApply == "") {
            return $this->DeleteDetailCoupondByProductId($listProductIDWannaApply, $couponID);
        } else {
            $array = explode(",", $listProductIDWannaApply);
            $this->DeleteDetailCoupondByProductId($listProductIDWannaApply, $couponID);
            $conn = $this->getInstance();
            $values = '';
    ...
    {
        $conn = $this->getInstance(); // Assuming this function returns the database connection
    ...
    {
        $conn = $this->getInstance();
        $couponExpiryIdsArray = $this->ListCoupondExpiry(); // Assuming this function returns an array of coupon expiry IDs
