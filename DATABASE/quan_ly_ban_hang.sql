...
CREATE TABLE IF NOT EXISTS `sanpham` (
  ...
  `src` varchar(255) DEFAULT '/SaleSphere/STATIC/assets/default.png',
...
INSERT INTO `sanpham` (`id`, `tenSanPham`, `giaBan`, `idLoaiSP`, `src`, `moTa`, `maDVT`, `trangthai`, `giaNhap`) VALUES
	(1, 'Samsung Galaxy S21', 12000000, 1, '/SaleSphere/STATIC/assets/iphone2.jpg', 'abc', 1, 1, 10000000),
	(2, 'Dell XPS 13', 25000000, 2, '/SaleSphere/STATIC/assets/product3.png', NULL, 2, 0, 20000000),
	(3, 'Instant Pot Duo', 1500000, 3, '/SaleSphere/STATIC/assets/product3.png', NULL, 3, 0, 1000000),
	(4, 'Nike Air Max', 2000000, 4, '/SaleSphere/STATIC/assets/product3.png', NULL, 4, 0, 1500000),
	(5, 'LEGO Star Wars Set', 500000, 5, '/SaleSphere/STATIC/assets/product3.png', NULL, 5, 1, 400000),
	(6, 'áo thun', 10000, 4, '/SaleSphere/STATIC/assets/product3.png', NULL, 5, 0, 8000),
	(7, 'Áo thun Polo unisex', 1200000, 4, '/SaleSphere/STATIC/assets/product3.png', NULL, 1, 0, 1000000),
	(8, 'iPhone 15 ultra', 25000000, 1, '/SaleSphere/STATIC/assets/iphone1.jpg', 'apple', 1, 1, 20000000),
	(9, 'Sữa bột', 200000, 7, '/SaleSphere/STATIC/assets/product3.png', NULL, 3, 0, 180000),
	(10, 'Sữa tươi', 15000, 7, '/SaleSphere/STATIC/assets/product3.png', NULL, 3, 0, 10000),
	(11, 'Mỳ hảo hảo', 5000, 7, '/SaleSphere/STATIC/assets/product3.png', NULL, 5, 0, 4000),
	(14, 'iPhone 15 promax', 23000000, 1, '/SaleSphere/STATIC/assets/product3.png', 'apple', 1, 0, 20000000),
	(16, 'iPhone 15 pro', 23000000, 1, '/SaleSphere/STATIC/assets/product3.png', 'apple', 1, 0, 20000000),
	(26, 'mỳ tôm hảo hảo', 5000, 1, '/SaleSphere/STATIC/assets/mytom1.jpg', 'hảo hảo', 1, 0, 4000),
	(28, 'ao thun nữ', 100000, 4, '/SaleSphere/STATIC/assets/aothun1.jpg', 'áo thun', 2, 0, 90000),
	(29, 'máy ảnh', 1000000, 2, '/SaleSphere/STATIC/assets/laptop2.jpg', 'máy ảnh', 1, 0, 900000),
	(30, 'Áo thun nao cao cấp', 320000, 4, '/SaleSphere/STATIC/assets/aothun1.jpg', '', 1, 1, 300000),
	(31, 'iPhone 15', 15000000, 1, '/SaleSphere/STATIC/assets/quantay2.png', '', 1, 0, 12000000),
	(32, 'Quầy tây nam', 499000, 4, '/SaleSphere/STATIC/assets/quantay1.jpg', '', 1, 1, 450000),
	(33, 'Quầy tây nam thời trang', 499000, 4, '/SaleSphere/STATIC/assets/quantay2.png', '', 1, 0, 450000),
	(34, 'Quầy tây nam thời trang cao cấp', 499000, 4, '/SaleSphere/STATIC/assets/quantay2.png', '', 1, 1, 450000),
	(35, 'laptop gamming', 499000, 2, '/SaleSphere/STATIC/assets/laptop1.jpg', '', 1, 1, 450000),
	(36, '1', 100000, 2, '/SaleSphere/STATIC/assets/default.png', 'áo thun', 1, 0, 90000),
	(37, '2', 100000, 1, '/SaleSphere/STATIC/assets/laptop1.jpg', 'áo thun', 1, 0, 90000),
	(38, 'Iphone 15', 23000000, 1, '/SaleSphere/STATIC/assets/iphone1.jpg', 'apple 15', 1, 1, 20000000),
	(39, 'iPhone 15', 23000000, 1, '/SaleSphere/STATIC/assets/iphone1.jpg', '', 1, 1, 20000000),
	(40, 'iPhone 15 abc', 23000000, 1, '/SaleSphere/STATIC/assets/iphone2.jpg', '', 1, 0, 20000000),
	(41, 'Tủ lạnh cao cấp', 19999000, 3, '/SaleSphere/STATIC/assets/tulanh1.jpg', 'Tủ lạnh cao cấp với thương hiệu nổi tiếng panasonic', 1, 1, 15000000);
...
INSERT INTO `users` (`id`, `ten`, `diachi`, `sdt`, `email`, `src`, `usertype`, `google_id`, `dob`, `facebook_id`, `gender`) VALUES
	(1, 'Nguyễn Văn A', 'xxxx', '1234567890', 'a@gmail.com', '/SaleSphere/STATIC/assets/poster.png', 'khachhang', NULL, NULL, NULL, NULL),
	(2, '0546_Dương Thành Trưởng', 'abc', '1234567111', 'dttruonga8tqtpy@gmail.com', '/SaleSphere/STATIC/assets/default_avatar_2.png', 'nhanvien', '107460906523637345202', '2003-02-25', NULL, 'Nam'),
